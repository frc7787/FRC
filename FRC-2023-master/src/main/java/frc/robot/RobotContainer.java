...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    new Trigger(ArmSubsystem::LimitSwitchForwardPressed).whileTrue(new DangerDo_NOT_USE(DriveSubsystem));
    new Trigger(ArmSubsystem::LimitSwitchReversePressed).whileFalse(new StopMotor(DriveSubsystem));
  }
// 
  /**
